...
(examples/emulators/nes/) and SNES (examples/emulators/snes/): CPU core validated
...
Run: `milo build examples/emulators/genesis/bootRun.milo -o /tmp/bootrun` then
...
renderer → PPM. Run: `milo run examples/emulators/genesis/bootRun.milo roms/games/sonic1.md 5000000`
...
Run: `examples/emulators/genesis/harte.sh [OPCODE ...]` (no args = default set).
...
```
milo build examples/emulators/genesis/runHarte.milo -o /tmp/runHarte68k --debug
milo build examples/emulators/genesis/genesis.milo -o /tmp/genesis --debug
