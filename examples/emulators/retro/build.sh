...
build examples/emulators/menu.milo            menu    --debug
build examples/emulators/nes/nes.milo         nes     "$opt"
build examples/emulators/genesis/genesis.milo genesis "$opt"
build examples/emulators/snes/snes.milo       snes    "$opt"
