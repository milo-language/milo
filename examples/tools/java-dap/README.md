...
```bash
examples/tools/java-dap/scripts/smoke.sh          # wire-level: handshake, IDSizes, threads
bun examples/tools/java-dap/scripts/dap-e2e.ts <java-dap-bin>       # full DAP session
bun examples/tools/java-dap/scripts/exception-e2e.ts <java-dap-bin> # exception breakpoints
bun examples/tools/java-dap/scripts/hades-e2e.ts <hades-bin> <java-dap-bin>  # via hades MCP
```
