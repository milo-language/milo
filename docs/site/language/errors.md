...
- [`'?' error type mismatch: 'Silent' cannot be boxed as 'Heap<Error>' because it does not satisfy interface 'Error' (needs message(self: &Self))`](#error-type-mismatch-silent-cannot-be-boxed-as-heap-error-because-it-does-not-satisfy-interface-error-needs-message-self-self)
...
- [`'@wrapping' takes no arguments`](#wrapping-takes-no-arguments-2)
...
- [`cannot move 'r.name' out of the borrowed 'r'`](#cannot-move-r-name-out-of-the-borrowed-r)
...
- [`enum 'E' is recursive by value and has infinite size`](#enum-e-is-recursive-by-value-and-has-infinite-size)
...
- [`write 'self: &mut Self'`](#write-self-mut-self)
- [`write 'self: &Self'`](#write-self-self)
- [`write 'self: Self'`](#write-self-self-2)
...
<sub>[tests/errors/propagateNotError.milo](https://github.com/milo-language/milo/blob/main/tests/errors/propagateNotError.milo)</sub>
...
<sub>[tests/errors/nullableRefAsReturn.milo](https://github.com/milo-language/milo/blob/main/tests/errors/nullableRefAsReturn.milo)</sub>
...
<sub>[tests/errors/nullableRefInClosureParam.milo](https://github.com/milo-language/milo/blob/main/tests/errors/nullableRefInClosureParam.milo)</sub>
...
<sub>[tests/errors/nullableRefInStructField.milo](https://github.com/milo-language/milo/blob/main/tests/errors/nullableRefInStructField.milo)</sub>
...
<sub>[tests/errors/nullableRefOutsideExtern.milo](https://github.com/milo-language/milo/blob/main/tests/errors/nullableRefOutsideExtern.milo)</sub>
...
<sub>[tests/errors/nullableRefTypeArg.milo](https://github.com/milo-language/milo/blob/main/tests/errors/nullableRefTypeArg.milo)</sub>
...
<sub>[tests/errors/moduleWrappingArgs.milo](https://github.com/milo-language/milo/blob/main/tests/errors/moduleWrappingArgs.milo)</sub>
...
<sub>[tests/errors/enumCopyAttrPointless.milo](https://github.com/milo-language/milo/blob/main/tests/errors/enumCopyAttrPointless.milo)</sub>
...
<sub>[tests/errors/copyOnPointerFreeStruct.milo](https://github.com/milo-language/milo/blob/main/tests/errors/copyOnPointerFreeStruct.milo)</sub>
...
<sub>[tests/errors/copyOnlyNoTypeParams.milo](https://github.com/milo-language/milo/blob/main/tests/errors/copyOnlyNoTypeParams.milo)</sub>
...
<sub>[tests/errors/copyOnlyArgNotTypeParam.milo](https://github.com/milo-language/milo/blob/main/tests/errors/copyOnlyArgNotTypeParam.milo)</sub>
...
<sub>[tests/errors/unknownAttrOnMethod.milo](https://github.com/milo-language/milo/blob/main/tests/errors/unknownAttrOnMethod.milo)</sub>
...
<sub>[tests/errors/mustUseArgsRejected.milo](https://github.com/milo-language/milo/blob/main/tests/errors/mustUseArgsRejected.milo)</sub>
...
<sub>[tests/errors/pureWithArgs.milo](https://github.com/milo-language/milo/blob/main/tests/errors/pureWithArgs.milo)</sub>
...
<sub>[tests/errors/wrappingOnExtern.milo](https://github.com/milo-language/milo/blob/main/tests/errors/wrappingOnExtern.milo)</sub>
...
<sub>[tests/errors/wrappingWithArgs.milo](https://github.com/milo-language/milo/blob/main/tests/errors/wrappingWithArgs.milo)</sub>
...
<sub>[tests/errors/explicitMutOnReceiver.milo](https://github.com/milo-language/milo/blob/main/tests/errors/explicitMutOnReceiver.milo)</sub>
...
<sub>[tests/errors/explicitMutNotAValue.milo](https://github.com/milo-language/milo/blob/main/tests/errors/explicitMutNotAValue.milo)</sub>
...
<sub>[tests/errors/explicitMutOnSharedParam.milo](https://github.com/milo-language/milo/blob/main/tests/errors/explicitMutOnSharedParam.milo)</sub>
...
<sub>[tests/errors/optionAndThenNotOption.milo](https://github.com/milo-language/milo/blob/main/tests/errors/optionAndThenNotOption.milo)</sub>
...
<sub>[tests/errors/resultAndThenErrMismatch.milo](https://github.com/milo-language/milo/blob/main/tests/errors/resultAndThenErrMismatch.milo)</sub>
...
<sub>[tests/errors/implMethodWrongReturnType.milo](https://github.com/milo-language/milo/blob/main/tests/errors/implMethodWrongReturnType.milo)</sub>
...
<sub>[tests/errors/copyOutArenaGetFn.milo](https://github.com/milo-language/milo/blob/main/tests/errors/copyOutArenaGetFn.milo)</sub>
...
<sub>[tests/errors/globalShadowsStdlibFn.milo](https://github.com/milo-language/milo/blob/main/tests/errors/globalShadowsStdlibFn.milo)</sub>
...
<sub>[tests/errors/nullableRefIntoOption.milo](https://github.com/milo-language/milo/blob/main/tests/errors/nullableRefIntoOption.milo)</sub>
...
<sub>[tests/errors/nullableRefMatchNotSupported.milo](https://github.com/milo-language/milo/blob/main/tests/errors/nullableRefMatchNotSupported.milo)</sub>
...
<sub>[tests/errors/nullableRefNotUnwrapped.milo](https://github.com/milo-language/milo/blob/main/tests/errors/nullableRefNotUnwrapped.milo)</sub>
...
<sub>[tests/errors/nullableRefPassedOn.milo](https://github.com/milo-language/milo/blob/main/tests/errors/nullableRefPassedOn.milo)</sub>
...
<sub>[tests/errors/breakOutsideLoop.milo](https://github.com/milo-language/milo/blob/main/tests/errors/breakOutsideLoop.milo)</sub>
...
<sub>[tests/errors/copyOnlyNamesWrittenType.milo](https://github.com/milo-language/milo/blob/main/tests/errors/copyOnlyNamesWrittenType.milo)</sub>
...
<sub>[tests/errors/dropElementVecClone.milo](https://github.com/milo-language/milo/blob/main/tests/errors/dropElementVecClone.milo)</sub>
...
<sub>[tests/errors/contextNotError.milo](https://github.com/milo-language/milo/blob/main/tests/errors/contextNotError.milo)</sub>
...
<sub>[tests/errors/shadowFnParamMatchArm.milo](https://github.com/milo-language/milo/blob/main/tests/errors/shadowFnParamMatchArm.milo)</sub>
...
<sub>[tests/errors/duplicateImplMethod.milo](https://github.com/milo-language/milo/blob/main/tests/errors/duplicateImplMethod.milo)</sub>
...
<sub>[tests/errors/duplicateFnDecl.milo](https://github.com/milo-language/milo/blob/main/tests/errors/duplicateFnDecl.milo)</sub>
...
<sub>[tests/errors/arenaBrandMixup.milo](https://github.com/milo-language/milo/blob/main/tests/errors/arenaBrandMixup.milo)</sub>
...
<sub>[tests/errors/copyOutArenaGet.milo](https://github.com/milo-language/milo/blob/main/tests/errors/copyOutArenaGet.milo)</sub>
...
<sub>[tests/errors/shadowFnParamNestedMatchArm.milo](https://github.com/milo-language/milo/blob/main/tests/errors/shadowFnParamNestedMatchArm.milo)</sub>
...
<sub>[tests/errors/mainBadReturn.milo](https://github.com/milo-language/milo/blob/main/tests/errors/mainBadReturn.milo)</sub>
...
<sub>[tests/errors/implGenericTraitSubstSelf.milo](https://github.com/milo-language/milo/blob/main/tests/errors/implGenericTraitSubstSelf.milo)</sub>
...
<sub>[tests/errors/shadowClosureParam.milo](https://github.com/milo-language/milo/blob/main/tests/errors/shadowClosureParam.milo)</sub>
...
<sub>[tests/errors/importNamedMissingSymbol.milo](https://github.com/milo-language/milo/blob/main/tests/errors/importNamedMissingSymbol.milo)</sub>
...
<sub>[tests/errors/externFnPtrAsValue.milo](https://github.com/milo-language/milo/blob/main/tests/errors/externFnPtrAsValue.milo)</sub>
...
<sub>[tests/errors/externFnPtrInVec.milo](https://github.com/milo-language/milo/blob/main/tests/errors/externFnPtrInVec.milo)</sub>
...
<sub>[tests/errors/externFnPtrPassedOn.milo](https://github.com/milo-language/milo/blob/main/tests/errors/externFnPtrPassedOn.milo)</sub>
...
<sub>[tests/errors/externFnPtrReturned.milo](https://github.com/milo-language/milo/blob/main/tests/errors/externFnPtrReturned.milo)</sub>
...
<sub>[tests/errors/redeclareBuiltinOption.milo](https://github.com/milo-language/milo/blob/main/tests/errors/redeclareBuiltinOption.milo)</sub>
...
<sub>[tests/errors/resultOrElseOkMismatch.milo](https://github.com/milo-language/milo/blob/main/tests/errors/resultOrElseOkMismatch.milo)</sub>
...
<sub>[tests/errors/ptrUsedAfterSourceMoved.milo](https://github.com/milo-language/milo/blob/main/tests/errors/ptrUsedAfterSourceMoved.milo)</sub>
...
<sub>[tests/errors/copyOnlyFnDropStruct.milo](https://github.com/milo-language/milo/blob/main/tests/errors/copyOnlyFnDropStruct.milo)</sub>
...
<sub>[tests/errors/importListRestrictsType.milo](https://github.com/milo-language/milo/blob/main/tests/errors/importListRestrictsType.milo)</sub>
...
<sub>[tests/errors/cstrOutlivesPush.milo](https://github.com/milo-language/milo/blob/main/tests/errors/cstrOutlivesPush.milo)</sub>
...
<sub>[tests/errors/saturatingArithNoArgs.milo](https://github.com/milo-language/milo/blob/main/tests/errors/saturatingArithNoArgs.milo)</sub>
...
<sub>[tests/errors/implMethodWrongArity.milo](https://github.com/milo-language/milo/blob/main/tests/errors/implMethodWrongArity.milo)</sub>
...
<sub>[tests/errors/globalSliceAcrossPark.milo](https://github.com/milo-language/milo/blob/main/tests/errors/globalSliceAcrossPark.milo)</sub>
...
<sub>[tests/errors/globalForInAcrossYield.milo](https://github.com/milo-language/milo/blob/main/tests/errors/globalForInAcrossYield.milo)</sub>
...
<sub>[tests/errors/shardsManualPathPrivate.milo](https://github.com/milo-language/milo/blob/main/tests/errors/shardsManualPathPrivate.milo)</sub>
...
<sub>[tests/errors/importListRestricts.milo](https://github.com/milo-language/milo/blob/main/tests/errors/importListRestricts.milo)</sub>
...
<sub>[tests/errors/globalForInParkTwoDeep.milo](https://github.com/milo-language/milo/blob/main/tests/errors/globalForInParkTwoDeep.milo)</sub>
...
<sub>[tests/errors/importListEmpty.milo](https://github.com/milo-language/milo/blob/main/tests/errors/importListEmpty.milo)</sub>
...
<sub>[tests/errors/duplicateStructDecl.milo](https://github.com/milo-language/milo/blob/main/tests/errors/duplicateStructDecl.milo)</sub>
...
<sub>[tests/errors/globalSliceArgAcrossPark.milo](https://github.com/milo-language/milo/blob/main/tests/errors/globalSliceArgAcrossPark.milo)</sub>
...
<sub>[tests/errors/typeShadowsPreludeType.milo](https://github.com/milo-language/milo/blob/main/tests/errors/typeShadowsPreludeType.milo)</sub>
...
<sub>[tests/errors/resultUnwrapOrElseNonCopy.milo](https://github.com/milo-language/milo/blob/main/tests/errors/resultUnwrapOrElseNonCopy.milo)</sub>
...
<sub>[tests/errors/ptrOutlivesReassign.milo](https://github.com/milo-language/milo/blob/main/tests/errors/ptrOutlivesReassign.milo)</sub>
...
<sub>[tests/errors/ptrOutlivesIndexWrite.milo](https://github.com/milo-language/milo/blob/main/tests/errors/ptrOutlivesIndexWrite.milo)</sub>
...
<sub>[tests/errors/ptrCastOutlivesRealloc.milo](https://github.com/milo-language/milo/blob/main/tests/errors/ptrCastOutlivesRealloc.milo)</sub>
...
<sub>[tests/errors/vecPtrOutlivesRealloc.milo](https://github.com/milo-language/milo/blob/main/tests/errors/vecPtrOutlivesRealloc.milo)</sub>
...
<sub>[tests/errors/ptrEscapesIntoVec.milo](https://github.com/milo-language/milo/blob/main/tests/errors/ptrEscapesIntoVec.milo)</sub>
...
<sub>[tests/errors/ptrReturnedParamIsView.milo](https://github.com/milo-language/milo/blob/main/tests/errors/ptrReturnedParamIsView.milo)</sub>
...
<sub>[tests/errors/vecVoidElement.milo](https://github.com/milo-language/milo/blob/main/tests/errors/vecVoidElement.milo)</sub>
...
<sub>[tests/errors/ptrOutlivesMovedSource.milo](https://github.com/milo-language/milo/blob/main/tests/errors/ptrOutlivesMovedSource.milo)</sub>
...
<sub>[tests/errors/ptrGlobalCalleePush.milo](https://github.com/milo-language/milo/blob/main/tests/errors/ptrGlobalCalleePush.milo)</sub>
...
<sub>[tests/errors/shadowIfLetBinding.milo](https://github.com/milo-language/milo/blob/main/tests/errors/shadowIfLetBinding.milo)</sub>
...
<sub>[tests/errors/shadowLetElseBinding.milo](https://github.com/milo-language/milo/blob/main/tests/errors/shadowLetElseBinding.milo)</sub>
...
<sub>[tests/errors/shadowWhileLetBinding.milo](https://github.com/milo-language/milo/blob/main/tests/errors/shadowWhileLetBinding.milo)</sub>
...
<sub>[tests/errors/globalForInParkUnannotatedWrapper.milo](https://github.com/milo-language/milo/blob/main/tests/errors/globalForInParkUnannotatedWrapper.milo)</sub>
...
<sub>[tests/errors/cLayoutNoSuchField.milo](https://github.com/milo-language/milo/blob/main/tests/errors/cLayoutNoSuchField.milo)</sub>
...
<sub>[tests/errors/cLayoutNoSuchType.milo](https://github.com/milo-language/milo/blob/main/tests/errors/cLayoutNoSuchType.milo)</sub>
...
<sub>[tests/errors/deriveJsonIntKeyedMap.milo](https://github.com/milo-language/milo/blob/main/tests/errors/deriveJsonIntKeyedMap.milo)</sub>
...
<sub>[tests/errors/resultAmbiguousFrom.milo](https://github.com/milo-language/milo/blob/main/tests/errors/resultAmbiguousFrom.milo)</sub>
...
<sub>[tests/errors/arrayOfRefs.milo](https://github.com/milo-language/milo/blob/main/tests/errors/arrayOfRefs.milo)</sub>
...
<sub>[tests/errors/vecCloneInterface.milo](https://github.com/milo-language/milo/blob/main/tests/errors/vecCloneInterface.milo)</sub>
...
<sub>[tests/errors/globalBorrowArgRealloc.milo](https://github.com/milo-language/milo/blob/main/tests/errors/globalBorrowArgRealloc.milo)</sub>
...
<sub>[tests/errors/implicitMutBorrow.milo](https://github.com/milo-language/milo/blob/main/tests/errors/implicitMutBorrow.milo)</sub>
...
<sub>[tests/errors/brandMismatchNamesWrittenType.milo](https://github.com/milo-language/milo/blob/main/tests/errors/brandMismatchNamesWrittenType.milo)</sub>
...
<sub>[tests/errors/arrayLiteralElementType.milo](https://github.com/milo-language/milo/blob/main/tests/errors/arrayLiteralElementType.milo)</sub>
...
<sub>[tests/errors/assertBadArg.milo](https://github.com/milo-language/milo/blob/main/tests/errors/assertBadArg.milo)</sub>
...
<sub>[tests/errors/assertTooManyArgs.milo](https://github.com/milo-language/milo/blob/main/tests/errors/assertTooManyArgs.milo)</sub>
...
<sub>[tests/errors/forInElementAssign.milo](https://github.com/milo-language/milo/blob/main/tests/errors/forInElementAssign.milo)</sub>
...
<sub>[tests/errors/callSiteExclusivity.milo](https://github.com/milo-language/milo/blob/main/tests/errors/callSiteExclusivity.milo)</sub>
...
<sub>[tests/errors/aliasMutContainerElement.milo](https://github.com/milo-language/milo/blob/main/tests/errors/aliasMutContainerElement.milo)</sub>

## `C header disagrees` {#c-header-disagrees}

A wrong field width is the silent-corruption case @cLayout exists to catch: tv\_sec as i32 still leaves tv\_nsec at offset 8 (i64 alignment pads it), so every offset matches and only the field's own size gives the drift away.
...
<sub>[tests/errors/cLayoutMismatch.milo](https://github.com/milo-language/milo/blob/main/tests/errors/cLayoutMismatch.milo)</sub>
...
<sub>[tests/errors/withRawNeedsUnsafe.milo](https://github.com/milo-language/milo/blob/main/tests/errors/withRawNeedsUnsafe.milo)</sub>
...
<sub>[tests/errors/externTypeByValue.milo](https://github.com/milo-language/milo/blob/main/tests/errors/externTypeByValue.milo)</sub>
...
<sub>[tests/errors/nullableRefSharedWrite.milo](https://github.com/milo-language/milo/blob/main/tests/errors/nullableRefSharedWrite.milo)</sub>
...
<sub>[tests/errors/globalLetStructAssign.milo](https://github.com/milo-language/milo/blob/main/tests/errors/globalLetStructAssign.milo)</sub>
...
<sub>[tests/errors/assignToLet.milo](https://github.com/milo-language/milo/blob/main/tests/errors/assignToLet.milo)</sub>
...
<sub>[tests/errors/genericVoidArg.milo](https://github.com/milo-language/milo/blob/main/tests/errors/genericVoidArg.milo)</sub>
...
<sub>[tests/errors/genericVoidArgInferred.milo](https://github.com/milo-language/milo/blob/main/tests/errors/genericVoidArgInferred.milo)</sub>
...
<sub>[tests/errors/stringPushWhileSliced.milo](https://github.com/milo-language/milo/blob/main/tests/errors/stringPushWhileSliced.milo)</sub>
...
<sub>[tests/errors/enumReprPayload.milo](https://github.com/milo-language/milo/blob/main/tests/errors/enumReprPayload.milo)</sub>
...
<sub>[tests/errors/vecClearImmutable.milo](https://github.com/milo-language/milo/blob/main/tests/errors/vecClearImmutable.milo)</sub>
...
<sub>[tests/errors/deriveTemplateUnknown.milo](https://github.com/milo-language/milo/blob/main/tests/errors/deriveTemplateUnknown.milo)</sub>
...
<sub>[tests/errors/cloneDeriveEnumClosurePayload.milo](https://github.com/milo-language/milo/blob/main/tests/errors/cloneDeriveEnumClosurePayload.milo)</sub>
...
<sub>[tests/errors/deriveCloneDrop.milo](https://github.com/milo-language/milo/blob/main/tests/errors/deriveCloneDrop.milo)</sub>
...
<sub>[tests/errors/deriveClonePointerField.milo](https://github.com/milo-language/milo/blob/main/tests/errors/deriveClonePointerField.milo)</sub>
...
<sub>[tests/errors/cloneDeriveEnumDrop.milo](https://github.com/milo-language/milo/blob/main/tests/errors/cloneDeriveEnumDrop.milo)</sub>
...
<sub>[tests/errors/cloneDeriveOptionClosure.milo](https://github.com/milo-language/milo/blob/main/tests/errors/cloneDeriveOptionClosure.milo)</sub>
...
<sub>[tests/errors/cloneDeriveExplicitNoCopyField.milo](https://github.com/milo-language/milo/blob/main/tests/errors/cloneDeriveExplicitNoCopyField.milo)</sub>
...
<sub>[tests/errors/voidLocalBinding.milo](https://github.com/milo-language/milo/blob/main/tests/errors/voidLocalBinding.milo)</sub>
...
<sub>[tests/errors/closureInferNoHint.milo](https://github.com/milo-language/milo/blob/main/tests/errors/closureInferNoHint.milo)</sub>
...
<sub>[tests/errors/nullNonOptional.milo](https://github.com/milo-language/milo/blob/main/tests/errors/nullNonOptional.milo)</sub>
...
<sub>[tests/errors/vec_infer_no_push.milo](https://github.com/milo-language/milo/blob/main/tests/errors/vec_infer_no_push.milo)</sub>
...
<sub>[tests/errors/moveFieldOutOfBorrowDefaultValue.milo](https://github.com/milo-language/milo/blob/main/tests/errors/moveFieldOutOfBorrowDefaultValue.milo)</sub>
...
<sub>[tests/errors/moveFieldOutOfBorrowIfExpr.milo](https://github.com/milo-language/milo/blob/main/tests/errors/moveFieldOutOfBorrowIfExpr.milo)</sub>
...
<sub>[tests/errors/moveFieldOutOfBorrowMatchExpr.milo](https://github.com/milo-language/milo/blob/main/tests/errors/moveFieldOutOfBorrowMatchExpr.milo)</sub>
...
<sub>[tests/errors/moveFieldOutOfBorrow.milo](https://github.com/milo-language/milo/blob/main/tests/errors/moveFieldOutOfBorrow.milo)</sub>
...
<sub>[tests/errors/closureMoveInLoopViaCall.milo](https://github.com/milo-language/milo/blob/main/tests/errors/closureMoveInLoopViaCall.milo)</sub>
...
<sub>[tests/errors/destructureBorrowed.milo](https://github.com/milo-language/milo/blob/main/tests/errors/destructureBorrowed.milo)</sub>
...
<sub>[tests/errors/nestedFieldMoveOutOfBorrow.milo](https://github.com/milo-language/milo/blob/main/tests/errors/nestedFieldMoveOutOfBorrow.milo)</sub>
...
<sub>[tests/errors/moveEnumFieldOutOfIndexedElement.milo](https://github.com/milo-language/milo/blob/main/tests/errors/moveEnumFieldOutOfIndexedElement.milo)</sub>
...
<sub>[tests/errors/moveFieldOutOfIndexedElement.milo](https://github.com/milo-language/milo/blob/main/tests/errors/moveFieldOutOfIndexedElement.milo)</sub>
...
<sub>[tests/errors/keyExtractorUserCombinator.milo](https://github.com/milo-language/milo/blob/main/tests/errors/keyExtractorUserCombinator.milo)</sub>
...
<sub>[tests/errors/importMissing.milo](https://github.com/milo-language/milo/blob/main/tests/errors/importMissing.milo)</sub>
...
<sub>[tests/errors/escapingClosurePromiseBlocking.milo](https://github.com/milo-language/milo/blob/main/tests/errors/escapingClosurePromiseBlocking.milo)</sub>
...
<sub>[tests/errors/escapingClosureTaskSpawn.milo](https://github.com/milo-language/milo/blob/main/tests/errors/escapingClosureTaskSpawn.milo)</sub>
...
<sub>[tests/errors/escapingClosureRetainedArg.milo](https://github.com/milo-language/milo/blob/main/tests/errors/escapingClosureRetainedArg.milo)</sub>
...
<sub>[tests/errors/mutSliceImmutable.milo](https://github.com/milo-language/milo/blob/main/tests/errors/mutSliceImmutable.milo)</sub>
...
<sub>[tests/errors/letToMutParam.milo](https://github.com/milo-language/milo/blob/main/tests/errors/letToMutParam.milo)</sub>
...
<sub>[tests/errors/replaceImmutable.milo](https://github.com/milo-language/milo/blob/main/tests/errors/replaceImmutable.milo)</sub>
...
<sub>[tests/errors/ptrReturnDangles.milo](https://github.com/milo-language/milo/blob/main/tests/errors/ptrReturnDangles.milo)</sub>
...
<sub>[tests/errors/escapingClosureAlias.milo](https://github.com/milo-language/milo/blob/main/tests/errors/escapingClosureAlias.milo)</sub>
...
<sub>[tests/errors/escapingClosureMoveLaunder.milo](https://github.com/milo-language/milo/blob/main/tests/errors/escapingClosureMoveLaunder.milo)</sub>
...
<sub>[tests/errors/escapingClosureReturn.milo](https://github.com/milo-language/milo/blob/main/tests/errors/escapingClosureReturn.milo)</sub>
...
<sub>[tests/errors/viewReturnFreeFn.milo](https://github.com/milo-language/milo/blob/main/tests/errors/viewReturnFreeFn.milo)</sub>
...
<sub>[tests/errors/optionOfViewReturn.milo](https://github.com/milo-language/milo/blob/main/tests/errors/optionOfViewReturn.milo)</sub>
...
<sub>[tests/errors/promiseBlockingNotSend.milo](https://github.com/milo-language/milo/blob/main/tests/errors/promiseBlockingNotSend.milo)</sub>
...
<sub>[tests/errors/spawnDetachedNotSend.milo](https://github.com/milo-language/milo/blob/main/tests/errors/spawnDetachedNotSend.milo)</sub>
...
<sub>[tests/errors/spawnNotSend.milo](https://github.com/milo-language/milo/blob/main/tests/errors/spawnNotSend.milo)</sub>
...
<sub>[tests/errors/spawnNotSendStruct.milo](https://github.com/milo-language/milo/blob/main/tests/errors/spawnNotSendStruct.milo)</sub>
...
<sub>[tests/errors/closureStoredInStruct.milo](https://github.com/milo-language/milo/blob/main/tests/errors/closureStoredInStruct.milo)</sub>
...
<sub>[tests/errors/closureStoredInVec.milo](https://github.com/milo-language/milo/blob/main/tests/errors/closureStoredInVec.milo)</sub>
...
<sub>[tests/errors/escapingClosureAssign.milo](https://github.com/milo-language/milo/blob/main/tests/errors/escapingClosureAssign.milo)</sub>
...
<sub>[tests/errors/indexDropElement.milo](https://github.com/milo-language/milo/blob/main/tests/errors/indexDropElement.milo)</sub>
...
<sub>[tests/errors/indexPointerFieldElement.milo](https://github.com/milo-language/milo/blob/main/tests/errors/indexPointerFieldElement.milo)</sub>
...
<sub>[tests/errors/dropElementAsCallArg.milo](https://github.com/milo-language/milo/blob/main/tests/errors/dropElementAsCallArg.milo)</sub>
...
<sub>[tests/errors/dropElementAssigned.milo](https://github.com/milo-language/milo/blob/main/tests/errors/dropElementAssigned.milo)</sub>
...
<sub>[tests/errors/dropElementInStructLit.milo](https://github.com/milo-language/milo/blob/main/tests/errors/dropElementInStructLit.milo)</sub>
...
<sub>[tests/errors/dropElementIntoEnumPayload.milo](https://github.com/milo-language/milo/blob/main/tests/errors/dropElementIntoEnumPayload.milo)</sub>
...
<sub>[tests/errors/dropElementReturned.milo](https://github.com/milo-language/milo/blob/main/tests/errors/dropElementReturned.milo)</sub>
...
<sub>[tests/errors/sliceOfTemporary.milo](https://github.com/milo-language/milo/blob/main/tests/errors/sliceOfTemporary.milo)</sub>
...
<sub>[tests/errors/enumCastFloat.milo](https://github.com/milo-language/milo/blob/main/tests/errors/enumCastFloat.milo)</sub>
...
<sub>[tests/errors/fallOffEndClosure.milo](https://github.com/milo-language/milo/blob/main/tests/errors/fallOffEndClosure.milo)</sub>
...
<sub>[tests/errors/deriveTemplateBuiltinName.milo](https://github.com/milo-language/milo/blob/main/tests/errors/deriveTemplateBuiltinName.milo)</sub>
...
<sub>[tests/errors/constExprOverflow.milo](https://github.com/milo-language/milo/blob/main/tests/errors/constExprOverflow.milo)</sub>
...
<sub>[tests/errors/externStructMiloByValue.milo](https://github.com/milo-language/milo/blob/main/tests/errors/externStructMiloByValue.milo)</sub>
...
<sub>[tests/errors/ptrDepthMismatch.milo](https://github.com/milo-language/milo/blob/main/tests/errors/ptrDepthMismatch.milo)</sub>
...
<sub>[tests/errors/decodeResultIgnored.milo](https://github.com/milo-language/milo/blob/main/tests/errors/decodeResultIgnored.milo)</sub>
...
<sub>[tests/errors/decreasesNotInteger.milo](https://github.com/milo-language/milo/blob/main/tests/errors/decreasesNotInteger.milo)</sub>
...
<sub>[tests/errors/methodNameSuggestion.milo](https://github.com/milo-language/milo/blob/main/tests/errors/methodNameSuggestion.milo)</sub>
...
<sub>[tests/errors/enumReprOutOfRange.milo](https://github.com/milo-language/milo/blob/main/tests/errors/enumReprOutOfRange.milo)</sub>
...
<sub>[tests/errors/traitBoundUnsatisfied.milo](https://github.com/milo-language/milo/blob/main/tests/errors/traitBoundUnsatisfied.milo)</sub>
...
<sub>[tests/errors/structBoundUnsatisfied.milo](https://github.com/milo-language/milo/blob/main/tests/errors/structBoundUnsatisfied.milo)</sub>
...
<sub>[tests/errors/interfaceNotSatisfied.milo](https://github.com/milo-language/milo/blob/main/tests/errors/interfaceNotSatisfied.milo)</sub>
...
<sub>[tests/errors/ensuresTypeMismatch.milo](https://github.com/milo-language/milo/blob/main/tests/errors/ensuresTypeMismatch.milo)</sub>
...
<sub>[tests/errors/enumRecursiveThroughStruct.milo](https://github.com/milo-language/milo/blob/main/tests/errors/enumRecursiveThroughStruct.milo)</sub>
...
<sub>[tests/errors/recursiveEnumNoHeap.milo](https://github.com/milo-language/milo/blob/main/tests/errors/recursiveEnumNoHeap.milo)</sub>
...
<sub>[tests/errors/useBeforeInit.milo](https://github.com/milo-language/milo/blob/main/tests/errors/useBeforeInit.milo)</sub>
...
<sub>[tests/errors/parseExpectedToken.milo](https://github.com/milo-language/milo/blob/main/tests/errors/parseExpectedToken.milo)</sub>
...
<sub>[tests/errors/externTypeMismatch.milo](https://github.com/milo-language/milo/blob/main/tests/errors/externTypeMismatch.milo)</sub>
...
<sub>[tests/errors/truncatedStructFieldType.milo](https://github.com/milo-language/milo/blob/main/tests/errors/truncatedStructFieldType.milo)</sub>
...
<sub>[tests/errors/vecTruncateBadArg.milo](https://github.com/milo-language/milo/blob/main/tests/errors/vecTruncateBadArg.milo)</sub>
...
<sub>[tests/errors/newtypeCrossType.milo](https://github.com/milo-language/milo/blob/main/tests/errors/newtypeCrossType.milo)</sub>
...
<sub>[tests/errors/cLayoutBadArgs.milo](https://github.com/milo-language/milo/blob/main/tests/errors/cLayoutBadArgs.milo)</sub>
...
<sub>[tests/errors/wrongArgCount.milo](https://github.com/milo-language/milo/blob/main/tests/errors/wrongArgCount.milo)</sub>

## `extern 'fcntl' declares 3 fixed parameters but C fixes only 2` {#extern-fcntl-declares-3-fixed-parameters-but-c-fixes-only-2}

The exact declaration that cost node-milo hours: fcntl(fd, F\_SETFL, flags) with fixed arity compiles clean, but on AArch64 the variadic callee reads its third arg off the stack while a fixed-arity call passes it in a register — so O\_NONBLOCK never landed and every socket in the runtime stayed blocking. It presented as a throughput mystery, not as a bad declaration, because x86\_64's conventions coincide for integer args.
...
<sub>[tests/errors/privateFieldLiteral.milo](https://github.com/milo-language/milo/blob/main/tests/errors/privateFieldLiteral.milo)</sub>
...
<sub>[tests/errors/privateFieldRead.milo](https://github.com/milo-language/milo/blob/main/tests/errors/privateFieldRead.milo)</sub>
...
<sub>[tests/errors/forRangeType.milo](https://github.com/milo-language/milo/blob/main/tests/errors/forRangeType.milo)</sub>
...
<sub>[tests/errors/iterDelegateTwoFields.milo](https://github.com/milo-language/milo/blob/main/tests/errors/iterDelegateTwoFields.milo)</sub>
...
<sub>[tests/errors/staticMethodTypo.milo](https://github.com/milo-language/milo/blob/main/tests/errors/staticMethodTypo.milo)</sub>
...
<sub>[tests/errors/externFnPtrWrongSig.milo](https://github.com/milo-language/milo/blob/main/tests/errors/externFnPtrWrongSig.milo)</sub>
...
<sub>[tests/errors/jwtVerifyIsNotBool.milo](https://github.com/milo-language/milo/blob/main/tests/errors/jwtVerifyIsNotBool.milo)</sub>
...
<sub>[tests/errors/recursiveStructByValue.milo](https://github.com/milo-language/milo/blob/main/tests/errors/recursiveStructByValue.milo)</sub>
...
<sub>[tests/errors/recursiveGenericDepth.milo](https://github.com/milo-language/milo/blob/main/tests/errors/recursiveGenericDepth.milo)</sub>
...
<sub>[tests/errors/integerLiteralOverflow.milo](https://github.com/milo-language/milo/blob/main/tests/errors/integerLiteralOverflow.milo)</sub>
...
<sub>[tests/errors/enumReprGeneric.milo](https://github.com/milo-language/milo/blob/main/tests/errors/enumReprGeneric.milo)</sub>
...
<sub>[tests/errors/pureCallsImpure.milo](https://github.com/milo-language/milo/blob/main/tests/errors/pureCallsImpure.milo)</sub>
...
<sub>[tests/errors/pureCallsExtern.milo](https://github.com/milo-language/milo/blob/main/tests/errors/pureCallsExtern.milo)</sub>
...
<sub>[tests/errors/pureCallsFnValue.milo](https://github.com/milo-language/milo/blob/main/tests/errors/pureCallsFnValue.milo)</sub>
...
<sub>[tests/errors/pureUnsafeBlock.milo](https://github.com/milo-language/milo/blob/main/tests/errors/pureUnsafeBlock.milo)</sub>
...
<sub>[tests/errors/pureTouchesGlobal.milo](https://github.com/milo-language/milo/blob/main/tests/errors/pureTouchesGlobal.milo)</sub>
...
<sub>[tests/errors/matchCopyBindMutate.milo](https://github.com/milo-language/milo/blob/main/tests/errors/matchCopyBindMutate.milo)</sub>
...
<sub>[tests/errors/embedFileDirectory.milo](https://github.com/milo-language/milo/blob/main/tests/errors/embedFileDirectory.milo)</sub>
...
<sub>[tests/errors/threadGlobalRace.milo](https://github.com/milo-language/milo/blob/main/tests/errors/threadGlobalRace.milo)</sub>
...
<sub>[tests/errors/viewAliasesContainerArg.milo](https://github.com/milo-language/milo/blob/main/tests/errors/viewAliasesContainerArg.milo)</sub>
...
<sub>[tests/errors/mutViewAliasesContainerArg.milo](https://github.com/milo-language/milo/blob/main/tests/errors/mutViewAliasesContainerArg.milo)</sub>
...
<sub>[tests/errors/matchBindingAssign.milo](https://github.com/milo-language/milo/blob/main/tests/errors/matchBindingAssign.milo)</sub>
...
<sub>[tests/errors/readPartiallyMovedStruct.milo](https://github.com/milo-language/milo/blob/main/tests/errors/readPartiallyMovedStruct.milo)</sub>
...
<sub>[tests/errors/cSigBadSig.milo](https://github.com/milo-language/milo/blob/main/tests/errors/cSigBadSig.milo)</sub>
...
<sub>[tests/errors/cLayoutBadHeader.milo](https://github.com/milo-language/milo/blob/main/tests/errors/cLayoutBadHeader.milo)</sub>
...
<sub>[tests/errors/cValueBadName.milo](https://github.com/milo-language/milo/blob/main/tests/errors/cValueBadName.milo)</sub>
...
<sub>[tests/errors/cValueOnVar.milo](https://github.com/milo-language/milo/blob/main/tests/errors/cValueOnVar.milo)</sub>
...
<sub>[tests/errors/linkInjection.milo](https://github.com/milo-language/milo/blob/main/tests/errors/linkInjection.milo)</sub>
...
<sub>[tests/errors/externFnPtrMoveField.milo](https://github.com/milo-language/milo/blob/main/tests/errors/externFnPtrMoveField.milo)</sub>
...
<sub>[tests/errors/externFnPtrNonCRepr.milo](https://github.com/milo-language/milo/blob/main/tests/errors/externFnPtrNonCRepr.milo)</sub>
...
<sub>[tests/errors/externStructBadField.milo](https://github.com/milo-language/milo/blob/main/tests/errors/externStructBadField.milo)</sub>
...
<sub>[tests/errors/iterDelegateNotIterable.milo](https://github.com/milo-language/milo/blob/main/tests/errors/iterDelegateNotIterable.milo)</sub>
...
<sub>[tests/errors/cOpaqueUnknownFieldAttr.milo](https://github.com/milo-language/milo/blob/main/tests/errors/cOpaqueUnknownFieldAttr.milo)</sub>
...
<sub>[tests/errors/attributeOnEnum.milo](https://github.com/milo-language/milo/blob/main/tests/errors/attributeOnEnum.milo)</sub>

## `is not what unistd.h declares` {#is-not-what-unistd-h-declares}

asserts on a diagnostic that quotes unistd.h; the MSVC CRT has no such header, so the compile fails for a different reason and proves nothing. The stated C signature is wrong: sysconf returns `long`, not `int`. Checked exactly against the header via \_\_builtin\_types\_compatible\_p.
...
<sub>[tests/errors/cSigWrongC.milo](https://github.com/milo-language/milo/blob/main/tests/errors/cSigWrongC.milo)</sub>
...
<sub>[tests/errors/deriveTemplateFieldHole.milo](https://github.com/milo-language/milo/blob/main/tests/errors/deriveTemplateFieldHole.milo)</sub>
...
<sub>[tests/errors/jsonStringifyUnsupportedField.milo](https://github.com/milo-language/milo/blob/main/tests/errors/jsonStringifyUnsupportedField.milo)</sub>
...
<sub>[tests/errors/let-missing-value.milo](https://github.com/milo-language/milo/blob/main/tests/errors/let-missing-value.milo)</sub>
...
<sub>[tests/errors/letElseNoDiverge.milo](https://github.com/milo-language/milo/blob/main/tests/errors/letElseNoDiverge.milo)</sub>
...
<sub>[tests/errors/sendImplRequiresUnsafe.milo](https://github.com/milo-language/milo/blob/main/tests/errors/sendImplRequiresUnsafe.milo)</sub>
...
<sub>[tests/errors/cSigWrongMilo.milo](https://github.com/milo-language/milo/blob/main/tests/errors/cSigWrongMilo.milo)</sub>
...
<sub>[tests/errors/cSigParamWidth.milo](https://github.com/milo-language/milo/blob/main/tests/errors/cSigParamWidth.milo)</sub>
...
<sub>[tests/errors/noIncrementOperator.milo](https://github.com/milo-language/milo/blob/main/tests/errors/noIncrementOperator.milo)</sub>

## `Milo says offset 0` {#milo-says-offset-0}

Transposed fields: every read of tv\_sec would silently return nanoseconds. The widths match, so only the offsets catch this one.
...
<sub>[tests/errors/cLayoutTransposed.milo](https://github.com/milo-language/milo/blob/main/tests/errors/cLayoutTransposed.milo)</sub>
...
<sub>[tests/errors/cSigParamPointee.milo](https://github.com/milo-language/milo/blob/main/tests/errors/cSigParamPointee.milo)</sub>
...
<sub>[tests/errors/if_expr_mismatch.milo](https://github.com/milo-language/milo/blob/main/tests/errors/if_expr_mismatch.milo)</sub>
...
<sub>[tests/errors/traitMissingMethod.milo](https://github.com/milo-language/milo/blob/main/tests/errors/traitMissingMethod.milo)</sub>
...
<sub>[tests/errors/moveClosureCalledTwice.milo](https://github.com/milo-language/milo/blob/main/tests/errors/moveClosureCalledTwice.milo)</sub>
...
<sub>[tests/errors/cValueNotLiteral.milo](https://github.com/milo-language/milo/blob/main/tests/errors/cValueNotLiteral.milo)</sub>
...
<sub>[tests/errors/nullableRefElseFallsThrough.milo](https://github.com/milo-language/milo/blob/main/tests/errors/nullableRefElseFallsThrough.milo)</sub>
...
<sub>[tests/errors/externalLinkageOnExtern.milo](https://github.com/milo-language/milo/blob/main/tests/errors/externalLinkageOnExtern.milo)</sub>
...
<sub>[tests/errors/noEntryPoint.milo](https://github.com/milo-language/milo/blob/main/tests/errors/noEntryPoint.milo)</sub>
...
<sub>[tests/errors/fallOffEndMatchNonExhaustive.milo](https://github.com/milo-language/milo/blob/main/tests/errors/fallOffEndMatchNonExhaustive.milo)</sub>
...
<sub>[tests/errors/matchNonexhaustive.milo](https://github.com/milo-language/milo/blob/main/tests/errors/matchNonexhaustive.milo)</sub>
...
<sub>[tests/errors/uninhabitedStillRequiresLive.milo](https://github.com/milo-language/milo/blob/main/tests/errors/uninhabitedStillRequiresLive.milo)</sub>
...
<sub>[tests/errors/hashmapWrongKeyType.milo](https://github.com/milo-language/milo/blob/main/tests/errors/hashmapWrongKeyType.milo)</sub>
...
<sub>[tests/errors/oldOutsideEnsures.milo](https://github.com/milo-language/milo/blob/main/tests/errors/oldOutsideEnsures.milo)</sub>
...
<sub>[tests/errors/oldNonScalar.milo](https://github.com/milo-language/milo/blob/main/tests/errors/oldNonScalar.milo)</sub>
...
<sub>[tests/errors/cLayoutNotExtern.milo](https://github.com/milo-language/milo/blob/main/tests/errors/cLayoutNotExtern.milo)</sub>
...
<sub>[tests/errors/externFnPtrClosure.milo](https://github.com/milo-language/milo/blob/main/tests/errors/externFnPtrClosure.milo)</sub>
...
<sub>[tests/errors/link-attr-non-extern.milo](https://github.com/milo-language/milo/blob/main/tests/errors/link-attr-non-extern.milo)</sub>
...
<sub>[tests/errors/cSigOnMiloFn.milo](https://github.com/milo-language/milo/blob/main/tests/errors/cSigOnMiloFn.milo)</sub>
...
<sub>[tests/errors/cOpaqueOnMiloStruct.milo](https://github.com/milo-language/milo/blob/main/tests/errors/cOpaqueOnMiloStruct.milo)</sub>
...
<sub>[tests/errors/cValueNonInt.milo](https://github.com/milo-language/milo/blob/main/tests/errors/cValueNonInt.milo)</sub>
...
<sub>[tests/errors/stringViewIterStored.milo](https://github.com/milo-language/milo/blob/main/tests/errors/stringViewIterStored.milo)</sub>
...
<sub>[tests/errors/popReturnsOption.milo](https://github.com/milo-language/milo/blob/main/tests/errors/popReturnsOption.milo)</sub>
...
<sub>[tests/errors/rangeArg.milo](https://github.com/milo-language/milo/blob/main/tests/errors/rangeArg.milo)</sub>
...
<sub>[tests/errors/rangeReassign.milo](https://github.com/milo-language/milo/blob/main/tests/errors/rangeReassign.milo)</sub>
...
<sub>[tests/errors/rangeReturn.milo](https://github.com/milo-language/milo/blob/main/tests/errors/rangeReturn.milo)</sub>
...
<sub>[tests/errors/ifExprArmOverflow.milo](https://github.com/milo-language/milo/blob/main/tests/errors/ifExprArmOverflow.milo)</sub>
...
<sub>[tests/errors/externFnPtrStructParam.milo](https://github.com/milo-language/milo/blob/main/tests/errors/externFnPtrStructParam.milo)</sub>
...
<sub>[tests/errors/ptrFieldNoUnsafe.milo](https://github.com/milo-language/milo/blob/main/tests/errors/ptrFieldNoUnsafe.milo)</sub>
...
<sub>[tests/errors/ptrParamStoredInGlobalStruct.milo](https://github.com/milo-language/milo/blob/main/tests/errors/ptrParamStoredInGlobalStruct.milo)</sub>
...
<sub>[tests/errors/ptrParamStoredInGlobal.milo](https://github.com/milo-language/milo/blob/main/tests/errors/ptrParamStoredInGlobal.milo)</sub>
...
<sub>[tests/errors/ptrParamPushedIntoGlobal.milo](https://github.com/milo-language/milo/blob/main/tests/errors/ptrParamPushedIntoGlobal.milo)</sub>
...
<sub>[tests/errors/vecPushWrongType.milo](https://github.com/milo-language/milo/blob/main/tests/errors/vecPushWrongType.milo)</sub>
...
<sub>[tests/errors/rawTypeParamReadNotCopyOnly.milo](https://github.com/milo-language/milo/blob/main/tests/errors/rawTypeParamReadNotCopyOnly.milo)</sub>
...
<sub>[tests/errors/structFieldVecOfRefs.milo](https://github.com/milo-language/milo/blob/main/tests/errors/structFieldVecOfRefs.milo)</sub>
...
<sub>[tests/errors/vecOfRefsAnnotated.milo](https://github.com/milo-language/milo/blob/main/tests/errors/vecOfRefsAnnotated.milo)</sub>
...
<sub>[tests/errors/refInStruct.milo](https://github.com/milo-language/milo/blob/main/tests/errors/refInStruct.milo)</sub>
...
<sub>[tests/errors/unsafeExternPtrReturn.milo](https://github.com/milo-language/milo/blob/main/tests/errors/unsafeExternPtrReturn.milo)</sub>
...
<sub>[tests/errors/contractViolationClamp.milo](https://github.com/milo-language/milo/blob/main/tests/errors/contractViolationClamp.milo)</sub>
...
<sub>[tests/errors/contractViolation.milo](https://github.com/milo-language/milo/blob/main/tests/errors/contractViolation.milo)</sub>
...
<sub>[tests/errors/contractTypeMismatch.milo](https://github.com/milo-language/milo/blob/main/tests/errors/contractTypeMismatch.milo)</sub>
...
<sub>[tests/errors/propagateWrongRet.milo](https://github.com/milo-language/milo/blob/main/tests/errors/propagateWrongRet.milo)</sub>
...
<sub>[tests/errors/traitMissingSupertrait.milo](https://github.com/milo-language/milo/blob/main/tests/errors/traitMissingSupertrait.milo)</sub>
...
<sub>[tests/errors/stringArith.milo](https://github.com/milo-language/milo/blob/main/tests/errors/stringArith.milo)</sub>
...
<sub>[tests/errors/shadowsStdlib.milo](https://github.com/milo-language/milo/blob/main/tests/errors/shadowsStdlib.milo)</sub>
...
<sub>[tests/errors/loopVarShadow.milo](https://github.com/milo-language/milo/blob/main/tests/errors/loopVarShadow.milo)</sub>
...
<sub>[tests/errors/destructureUnknownField.milo](https://github.com/milo-language/milo/blob/main/tests/errors/destructureUnknownField.milo)</sub>
...
<sub>[tests/errors/genericStructInfiniteSizeIndirect.milo](https://github.com/milo-language/milo/blob/main/tests/errors/genericStructInfiniteSizeIndirect.milo)</sub>
...
<sub>[tests/errors/swapTypeMismatch.milo](https://github.com/milo-language/milo/blob/main/tests/errors/swapTypeMismatch.milo)</sub>
...
<sub>[tests/errors/cSigArityMismatch.milo](https://github.com/milo-language/milo/blob/main/tests/errors/cSigArityMismatch.milo)</sub>
...
<sub>[tests/errors/vecCallbackMovesOwned.milo](https://github.com/milo-language/milo/blob/main/tests/errors/vecCallbackMovesOwned.milo)</sub>
...
<sub>[tests/errors/mutSliceOverlapArgs.milo](https://github.com/milo-language/milo/blob/main/tests/errors/mutSliceOverlapArgs.milo)</sub>
...
<sub>[tests/errors/deriveJsonDuplicateKey.milo](https://github.com/milo-language/milo/blob/main/tests/errors/deriveJsonDuplicateKey.milo)</sub>
...
<sub>[tests/errors/slicePush.milo](https://github.com/milo-language/milo/blob/main/tests/errors/slicePush.milo)</sub>
...
<sub>[tests/errors/cyclicTypeAlias.milo](https://github.com/milo-language/milo/blob/main/tests/errors/cyclicTypeAlias.milo)</sub>
...
<sub>[tests/errors/cyclicGenericAlias.milo](https://github.com/milo-language/milo/blob/main/tests/errors/cyclicGenericAlias.milo)</sub>
...
<sub>[tests/errors/genericAliasBare.milo](https://github.com/milo-language/milo/blob/main/tests/errors/genericAliasBare.milo)</sub>
...
<sub>[tests/errors/genericAliasArity.milo](https://github.com/milo-language/milo/blob/main/tests/errors/genericAliasArity.milo)</sub>
...
<sub>[tests/errors/sendNotSend.milo](https://github.com/milo-language/milo/blob/main/tests/errors/sendNotSend.milo)</sub>
...
<sub>[tests/errors/typeMismatch.milo](https://github.com/milo-language/milo/blob/main/tests/errors/typeMismatch.milo)</sub>
...
<sub>[tests/errors/mixedSignArith.milo](https://github.com/milo-language/milo/blob/main/tests/errors/mixedSignArith.milo)</sub>
...
<sub>[tests/errors/mixedWidthArith.milo](https://github.com/milo-language/milo/blob/main/tests/errors/mixedWidthArith.milo)</sub>
...
<sub>[tests/errors/flexIntLocked.milo](https://github.com/milo-language/milo/blob/main/tests/errors/flexIntLocked.milo)</sub>
...
<sub>[tests/errors/genericAliasBound.milo](https://github.com/milo-language/milo/blob/main/tests/errors/genericAliasBound.milo)</sub>
...
<sub>[tests/errors/adoptHeapOutsideForeign.milo](https://github.com/milo-language/milo/blob/main/tests/errors/adoptHeapOutsideForeign.milo)</sub>
...
<sub>[tests/errors/adoptVecOutsideForeign.milo](https://github.com/milo-language/milo/blob/main/tests/errors/adoptVecOutsideForeign.milo)</sub>
...
<sub>[tests/errors/undefinedFn.milo](https://github.com/milo-language/milo/blob/main/tests/errors/undefinedFn.milo)</sub>
...
<sub>[tests/errors/rawSliceOutsideForeign.milo](https://github.com/milo-language/milo/blob/main/tests/errors/rawSliceOutsideForeign.milo)</sub>
...
<sub>[tests/errors/undefinedVar.milo](https://github.com/milo-language/milo/blob/main/tests/errors/undefinedVar.milo)</sub>
...
<sub>[tests/errors/unknownAttribute.milo](https://github.com/milo-language/milo/blob/main/tests/errors/unknownAttribute.milo)</sub>
...
<sub>[tests/errors/mustUseOnStructRejected.milo](https://github.com/milo-language/milo/blob/main/tests/errors/mustUseOnStructRejected.milo)</sub>
...
<sub>[tests/errors/unknownEscape.milo](https://github.com/milo-language/milo/blob/main/tests/errors/unknownEscape.milo)</sub>
...
<sub>[tests/errors/unreachableAfterBreak.milo](https://github.com/milo-language/milo/blob/main/tests/errors/unreachableAfterBreak.milo)</sub>
...
<sub>[tests/errors/unreachableAfterIfElseReturn.milo](https://github.com/milo-language/milo/blob/main/tests/errors/unreachableAfterIfElseReturn.milo)</sub>
...
<sub>[tests/errors/unreachableAfterVoidReturn.milo](https://github.com/milo-language/milo/blob/main/tests/errors/unreachableAfterVoidReturn.milo)</sub>
...
<sub>[tests/errors/unsafeImplNonMarker.milo](https://github.com/milo-language/milo/blob/main/tests/errors/unsafeImplNonMarker.milo)</sub>
...
<sub>[tests/errors/enumReprUnsupported.milo](https://github.com/milo-language/milo/blob/main/tests/errors/enumReprUnsupported.milo)</sub>
...
<sub>[tests/errors/parseIntIsOption.milo](https://github.com/milo-language/milo/blob/main/tests/errors/parseIntIsOption.milo)</sub>
...
<sub>[tests/errors/hashmapUseAfterMove.milo](https://github.com/milo-language/milo/blob/main/tests/errors/hashmapUseAfterMove.milo)</sub>
...
<sub>[tests/errors/noCopyDoubleFree.milo](https://github.com/milo-language/milo/blob/main/tests/errors/noCopyDoubleFree.milo)</sub>
...
<sub>[tests/errors/noCopyUseAfterFree.milo](https://github.com/milo-language/milo/blob/main/tests/errors/noCopyUseAfterFree.milo)</sub>
...
<sub>[tests/errors/sharedMutAcrossThreads.milo](https://github.com/milo-language/milo/blob/main/tests/errors/sharedMutAcrossThreads.milo)</sub>
...
<sub>[tests/errors/stringUseAfterMove.milo](https://github.com/milo-language/milo/blob/main/tests/errors/stringUseAfterMove.milo)</sub>
...
<sub>[tests/errors/arenaFreezeUseAfterMove.milo](https://github.com/milo-language/milo/blob/main/tests/errors/arenaFreezeUseAfterMove.milo)</sub>
...
<sub>[tests/errors/useAfterMoveIfExpr.milo](https://github.com/milo-language/milo/blob/main/tests/errors/useAfterMoveIfExpr.milo)</sub>
...
<sub>[tests/errors/useAfterMoveLetBinding.milo](https://github.com/milo-language/milo/blob/main/tests/errors/useAfterMoveLetBinding.milo)</sub>
...
<sub>[tests/errors/useAfterMoveMatchExpr.milo](https://github.com/milo-language/milo/blob/main/tests/errors/useAfterMoveMatchExpr.milo)</sub>
...
<sub>[tests/errors/coalesceMovesDefault.milo](https://github.com/milo-language/milo/blob/main/tests/errors/coalesceMovesDefault.milo)</sub>
...
<sub>[tests/errors/moveClosureNotCopy.milo](https://github.com/milo-language/milo/blob/main/tests/errors/moveClosureNotCopy.milo)</sub>
...
<sub>[tests/errors/coalesceMovesOperand.milo](https://github.com/milo-language/milo/blob/main/tests/errors/coalesceMovesOperand.milo)</sub>
...
<sub>[tests/errors/nestedPointerFieldUseAfterMove.milo](https://github.com/milo-language/milo/blob/main/tests/errors/nestedPointerFieldUseAfterMove.milo)</sub>
...
<sub>[tests/errors/optionOrElseUseAfterMove.milo](https://github.com/milo-language/milo/blob/main/tests/errors/optionOrElseUseAfterMove.milo)</sub>
...
<sub>[tests/errors/contextMovesReceiver.milo](https://github.com/milo-language/milo/blob/main/tests/errors/contextMovesReceiver.milo)</sub>
...
<sub>[tests/errors/propagateUseAfterMove.milo](https://github.com/milo-language/milo/blob/main/tests/errors/propagateUseAfterMove.milo)</sub>
...
<sub>[tests/errors/resultMapConsumesNonCopyErr.milo](https://github.com/milo-language/milo/blob/main/tests/errors/resultMapConsumesNonCopyErr.milo)</sub>
...
<sub>[tests/errors/enumPointerPayloadCopy.milo](https://github.com/milo-language/milo/blob/main/tests/errors/enumPointerPayloadCopy.milo)</sub>
...
<sub>[tests/errors/forgetEndsOwnership.milo](https://github.com/milo-language/milo/blob/main/tests/errors/forgetEndsOwnership.milo)</sub>
...
<sub>[tests/errors/heapUseAfterMove.milo](https://github.com/milo-language/milo/blob/main/tests/errors/heapUseAfterMove.milo)</sub>
...
<sub>[tests/errors/arrayNonCopyMove.milo](https://github.com/milo-language/milo/blob/main/tests/errors/arrayNonCopyMove.milo)</sub>
...
<sub>[tests/errors/ifLetSubjectReadInThen.milo](https://github.com/milo-language/milo/blob/main/tests/errors/ifLetSubjectReadInThen.milo)</sub>
...
<sub>[tests/errors/matchSubjectReadInArm.milo](https://github.com/milo-language/milo/blob/main/tests/errors/matchSubjectReadInArm.milo)</sub>
...
<sub>[tests/errors/rangeOverflowLiteral.milo](https://github.com/milo-language/milo/blob/main/tests/errors/rangeOverflowLiteral.milo)</sub>
...
<sub>[tests/errors/ifLetWrongBindings.milo](https://github.com/milo-language/milo/blob/main/tests/errors/ifLetWrongBindings.milo)</sub>
...
<sub>[tests/errors/movePartiallyMovedStruct.milo](https://github.com/milo-language/milo/blob/main/tests/errors/movePartiallyMovedStruct.milo)</sub>
...
<sub>[tests/errors/moveFieldOutOfDropType.milo](https://github.com/milo-language/milo/blob/main/tests/errors/moveFieldOutOfDropType.milo)</sub>
...
<sub>[tests/errors/rustReceiverRefMut.milo](https://github.com/milo-language/milo/blob/main/tests/errors/rustReceiverRefMut.milo)</sub>
...
<sub>[tests/errors/rustReceiverRef.milo](https://github.com/milo-language/milo/blob/main/tests/errors/rustReceiverRef.milo)</sub>
...
<sub>[tests/errors/rustReceiverBare.milo](https://github.com/milo-language/milo/blob/main/tests/errors/rustReceiverBare.milo)</sub>
...
<sub>[tests/errors/globalIterCalleeGrows.milo](https://github.com/milo-language/milo/blob/main/tests/errors/globalIterCalleeGrows.milo)</sub>
...
<sub>[tests/errors/globalIterCalleeReplaces.milo](https://github.com/milo-language/milo/blob/main/tests/errors/globalIterCalleeReplaces.milo)</sub>
