...
- **Test framework**: `@expect:`/`@error:` annotations and a `milo test` runner over <!-- stat:fixtures -->691<!-- /stat --> fixtures, plus <!-- stat:error-fixtures -->359<!-- /stat --> that must fail to compile and <!-- stat:prove-fixtures -->37<!-- /stat --> that must be proved
