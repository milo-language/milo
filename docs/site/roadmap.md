...
- **Test framework**: `@expect:`/`@error:` annotations and a `milo test` runner over <!-- stat:fixtures -->693<!-- /stat --> fixtures, plus <!-- stat:error-fixtures -->363<!-- /stat --> that must fail to compile and <!-- stat:prove-fixtures -->37<!-- /stat --> that must be proved
