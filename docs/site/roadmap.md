...
- **Test framework**: `@expect:`/`@error:` annotations and a `milo test` runner over <!-- stat:fixtures -->694<!-- /stat --> fixtures, plus <!-- stat:error-fixtures -->353<!-- /stat --> that must fail to compile and <!-- stat:prove-fixtures -->33<!-- /stat --> that must be proved
