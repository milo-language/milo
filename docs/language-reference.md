...
last-verified: 2026-09-19 (@parks cross-task freeze rule; ptr()/cstr() views on the one view list; @copyOnly and the raw type-param read rule; full snippet sweep last run 2026-07-31)
-->
