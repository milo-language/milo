...
Generated from `tests/errors/` by `scripts/gen-error-catalog.ts` — 357 distinct messages across 422 pinned programs.
...
<sub>[`tests/errors/propagateNotError.milo`](../tests/errors/propagateNotError.milo)</sub>
...
<sub>[`tests/errors/contextNotError.milo`](../tests/errors/contextNotError.milo)</sub>
...
<sub>[`tests/errors/matchMutSubjectFrozen.milo`](../tests/errors/matchMutSubjectFrozen.milo)</sub>
...
<sub>[`tests/errors/castArrayToInt.milo`](../tests/errors/castArrayToInt.milo)</sub>
...
<sub>[`tests/errors/destructureDropStruct.milo`](../tests/errors/destructureDropStruct.milo)</sub>
...
<sub>[`tests/errors/destructureBorrowed.milo`](../tests/errors/destructureBorrowed.milo)</sub>
...
<sub>[`tests/errors/moveEnumFieldOutOfIndexedElement.milo`](../tests/errors/moveEnumFieldOutOfIndexedElement.milo)</sub>
...
<sub>[`tests/errors/moveFieldOutOfIndexedElement.milo`](../tests/errors/moveFieldOutOfIndexedElement.milo)</sub>
...
<sub>[`tests/errors/enumRecursiveThroughStruct.milo`](../tests/errors/enumRecursiveThroughStruct.milo)</sub>
...
<sub>[`tests/errors/hashMapModifyReentrant.milo`](../tests/errors/hashMapModifyReentrant.milo)</sub>
...
<sub>[`tests/errors/destructureUnknownField.milo`](../tests/errors/destructureUnknownField.milo)</sub>
...
<sub>[`tests/errors/contextMovesReceiver.milo`](../tests/errors/contextMovesReceiver.milo)</sub>
...
<sub>[`tests/errors/rustReceiverRefMut.milo`](../tests/errors/rustReceiverRefMut.milo)</sub>
...
<sub>[`tests/errors/rustReceiverRef.milo`](../tests/errors/rustReceiverRef.milo)</sub>
...
<sub>[`tests/errors/rustReceiverBare.milo`](../tests/errors/rustReceiverBare.milo)</sub>
