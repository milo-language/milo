...
Add a test by dropping a `.milo` file in the right directory with the right annotation. That's it. (<!-- stat:fixtures -->692<!-- /stat --> fixtures, <!-- stat:error-fixtures -->337<!-- /stat --> error cases, <!-- stat:runtime-error-fixtures -->30<!-- /stat --> runtime-error cases.)
