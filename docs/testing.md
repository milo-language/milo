...
Add a test by dropping a `.milo` file in the right directory with the right annotation. That's it. (<!-- stat:fixtures -->727<!-- /stat --> fixtures, <!-- stat:error-fixtures -->417<!-- /stat --> error cases, <!-- stat:runtime-error-fixtures -->28<!-- /stat --> runtime-error cases.)
