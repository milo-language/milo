...
- **Test framework**: `@expect:`/`@error:` annotations, `milo test` runner — <!-- stat:fixtures -->692<!-- /stat --> fixtures, <!-- stat:error-fixtures -->346<!-- /stat --> error fixtures, <!-- stat:prove-fixtures -->33<!-- /stat --> prove fixtures
