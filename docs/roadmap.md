...
last-verified: 2026-09-19 (prover: builtin container contracts, len kept across len-preserving loops, honest verdicts on contract-less havocs; earlier: self-host endgame decided proof-only and src-milo frozen; packages ecosystem at 8 published with an install-and-build gate; green main; counts re-measured)
-->
...
- **Test framework**: `@expect:`/`@error:` annotations, `milo test` runner — <!-- stat:fixtures -->719<!-- /stat --> fixtures, <!-- stat:error-fixtures -->401<!-- /stat --> error fixtures, <!-- stat:prove-fixtures -->38<!-- /stat --> prove fixtures
