...
- **Test framework**: `@expect:`/`@error:` annotations, `milo test` runner — <!-- stat:fixtures -->724<!-- /stat --> fixtures, <!-- stat:error-fixtures -->411<!-- /stat --> error fixtures, <!-- stat:prove-fixtures -->38<!-- /stat --> prove fixtures
...
- [ ] **Tuples** — there is no tuple type: `for i, x in v` binds an index and an element (shipped, `tests/fixtures/enumerate.milo`) but a function cannot return two values without a one-off struct. Backlog A1 has the case and the cost
