...
key-files: worksheets/TEMPLATE.md, AGENT_WORKFLOW.md
...
## Protocol
1. **Start of task:** copy `TEMPLATE.md` to `worksheets/<YYYY-MM-DD>-<slug>.md`. Fill in goal + plan.
...
## Naming
`worksheets/2026-07-11-fix-move-checker-clone-hint.md` — date + kebab slug. The slug is also the git tag (`ws/fix-move-checker-clone-hint`).
